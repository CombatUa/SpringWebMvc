                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <mvc:hidden path="id" id="userid-text-input"
                                           cssClass="form-control" value="${u.id}"></mvc:hidden>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <mvc:input path="firstName" id="firstname-text-input"
                                           cssClass="form-control" value="${u.firstName}"></mvc:input>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <mvc:input path="lastName" cssClass="form-control" value="${u.lastName}"></mvc:input>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <mvc:input path="salary" cssClass="form-control" value="${u.salary}"></mvc:input>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <mvc:input path="dateOfBirth" type="date" placeholder="yyyy-mm-dd"
                                           cssClass="form-control" value="${u.dateOfBirth}"></mvc:input>
